...
//Menus suspensos de moeda (select)
...
async function getExchangeRate() {
    ...
    try {
        const response = await fetch(`https://v6.exchangerate-api.com/v6/6c9ec04b4db9f74edf4a1226/latest/${fromCur.value}`);
...
//Evento para botão e clique no ícone de troca
